...
public class AdressController {
	...
	@PostMapping
	public ResponseEntity<ResponseStructuer<AdressDto>> saveAdress(@RequestBody Adress adress){
		return adressService.saveAdress(adress);
	}
	@PutMapping
	public ResponseEntity<ResponseStructuer<AdressDto>> updateAdress(@RequestParam int adressId,@RequestBody Adress adress){
		return adressService.updateAdress(adressId,adress);
	}
	@GetMapping
	public ResponseEntity<ResponseStructuer<AdressDto>> findAdress(@RequestParam int adressId){
		return adressService.findAdress(adressId);
	}
	@DeleteMapping
	public ResponseEntity<ResponseStructuer<AdressDto>> deleteAdress(@RequestParam int adressId){
